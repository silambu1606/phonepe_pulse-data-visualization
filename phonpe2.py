...
choropleth_data['state']=choropleth_data['state'].replace({'andaman-&-nicobar-islands':'Andaman & Nicobar','andhra-pradesh':'Andhra Pradesh','arunachal-pradesh':'Arunachal Pradesh','assam':'Assam','bihar':"Bihar", 'chandigarh':"Chandigarh", 'chhattisgarh':"Chhattisgarh",
